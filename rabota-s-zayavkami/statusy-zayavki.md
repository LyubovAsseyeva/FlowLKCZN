...
{% hint style="info" %}
В  2024 году появился **новый документ "Соглашение о намерениях"**,  который заключается  на РР.

Подписание соглашения и договора (также остальных документов на зачисление) будет идти  параллельно.

Договор с гражданином может быть заключен до подписания Соглашения о намерениях. Договор будет считаться недействительным, если не будет заключено Соглашение о намерениях.
{% endhint %}
...
**Требуется загрузить документ об образовании**. Для категории граждан **Студент** <mark style="color:orange;">находится в разработке</mark>.

**Требуется проверить документ об образовании**. Для категории граждан **Студент** <mark style="color:orange;">находится в разработке</mark>.

**Отклонен документ об образовании.** Для категории граждан **Студент** <mark style="color:orange;">находится в разработке.</mark> &#x20;
